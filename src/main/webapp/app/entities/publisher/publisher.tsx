  ...
  return (
    <div>
      <h2 id="publisher-heading" data-cy="PublisherHeading">
        <Translate contentKey="jhipsterFirstApp.publisher.home.title">Publishers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterFirstApp.publisher.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/publisher/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterFirstApp.publisher.home.createLabel">Create new Publisher</Translate>
          </Link>
        </div>
      </h2>
        ...
        {publisherList && publisherList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterFirstApp.publisher.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="jhipsterFirstApp.publisher.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterFirstApp.publisher.home.notFound">No Publishers found</Translate>
            </div>
          )
        )}
      </div>
