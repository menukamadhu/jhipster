...
export const PublisherDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFirstApp.publisher.delete.question">
        <Translate contentKey="jhipsterFirstApp.publisher.delete.question" interpolate={{ id: publisherEntity.id }}>
