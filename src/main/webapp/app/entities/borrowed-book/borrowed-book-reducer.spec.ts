...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BORROWEDBOOK_LIST actions', async () => {
    ...
    it('dispatches FETCH_BORROWEDBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BORROWEDBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BORROWEDBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BORROWEDBOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BORROWEDBOOK actions', async () => {
      const expectedActions = [
        {
