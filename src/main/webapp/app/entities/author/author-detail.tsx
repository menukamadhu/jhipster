    ...
    <Row>
      <Col md="8">
        <h2 data-cy="authorDetailsHeading">
          <Translate contentKey="jhipsterFirstApp.author.detail.title">Author</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="firstName">
              <Translate contentKey="jhipsterFirstApp.author.firstName">First Name</Translate>
            </span>
          </dt>
          <dd>{authorEntity.firstName}</dd>
          <dt>
            <span id="lastName">
              <Translate contentKey="jhipsterFirstApp.author.lastName">Last Name</Translate>
            </span>
          </dt>
