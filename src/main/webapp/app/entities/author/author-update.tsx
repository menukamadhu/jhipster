  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterFirstApp.author.home.createOrEditLabel" data-cy="AuthorCreateUpdateHeading">
            <Translate contentKey="jhipsterFirstApp.author.home.createOrEditLabel">Create or edit a Author</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterFirstApp.author.firstName')}
                id="author-firstName"
                name="firstName"
                data-cy="firstName"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterFirstApp.author.lastName')}
                id="author-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
